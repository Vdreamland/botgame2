...
| Reforge stones | 13 | `reforge_effect_reroll ×10` + `reforge_effect_add ×1` + `reforge_effect_remove ×1` + `reforge_stat_reroll ×1` |
...
{ "success": true, "data": {
  "items": [
    ...
    { "acquiredItemKey": "reforge_effect_reroll", "acquiredItemName": "Effect Reroll Stone", "quantity": 10, "kind": "item" },
    { "acquiredItemKey": "reforge_effect_add",    "acquiredItemName": "Effect Add Stone",    "quantity": 1,  "kind": "item" },
    { "acquiredItemKey": "reforge_effect_remove", "acquiredItemName": "Effect Remove Stone", "quantity": 1,  "kind": "item" },
    { "acquiredItemKey": "reforge_stat_reroll",   "acquiredItemName": "Stat Reroll Stone",   "quantity": 1,  "kind": "item" }
  ],
  "replayed": false
} }
```
