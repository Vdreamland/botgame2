...
from helpers.websocket_client import ClawRoyaleWebSocketClient, handle_game_message
    ...
    while True:
        try:
            ...
            for game in active_games:
                ...
                if g_id in dead_games and game.get("gameStatus") != "finished":
                    wait_for_game_id = g_id
                    break
            ...
            if wait_for_game_id:
                ...
                for game in active_games:
                    if game.get("gameId") == wait_for_game_id and game.get("gameStatus") != "finished":
                        ...
                        break
                if is_still_running:
                    print(f"[Lobby] Previous game {wait_for_game_id} is still running on server. Waiting for it to finish...")
